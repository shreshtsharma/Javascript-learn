class User{
    ...
    // they come in use when we want to set a different value and show a different value or 
    // when we want to provide limited access to some users
    get password(){
    ...
    get email(){
        return `email is ${this._email}hello`
    }
    set email(value)
    {
        this._email=value;
...
const user=new User("sharma@yahoo.com","shresht")
